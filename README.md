...
* instalas ngrok: abres una nueva powershell como administrador y ejecutas:
    choco install ngrok
* verificas que ngrok esta instalado: ngrok version en la terminal de windsurf
* inicias secion en ngrok, vas a autenticacion, y copias el token
* ejecutas:ngrok config add-authtoken 32joMyUZLlYdj0x7W2Tdp6Nsogc_5qamnCuiTNPdXJtTsNDf8
...
# TEORIA:
* instalamos axios @tanstack/react-query, sonner y mongodb
